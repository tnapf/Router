...
class HttpNotAcceptable extends HttpException
{
    ...
    public const DESCRIPTION = "Indicates that the target resource does not have a 
current representation that would be acceptable to 
the user agent, according to the proactive negotiation 
