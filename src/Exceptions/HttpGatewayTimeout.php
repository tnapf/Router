...
class HttpGatewayTimeout extends HttpException
{
    ...
    public const DESCRIPTION = "Indicates that the server, while acting as a gateway 
or proxy, did not receive a timely response from an 
upstream server it needed to access in order to complete 
the request.";
